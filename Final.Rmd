...
kable(merged_summary, caption = "Summary of the numeric variables (rates)") |> 
...
ggplot(merged, aes(x = stream)) +
  ...
  plot_layout(nrow = 3) +
  plot_annotation(title = "Distributions of the outcome variables (rates)")
...
ggplot(merged, aes(x = stream_count)) +
  ...
  plot_layout(nrow = 3) +
  plot_annotation(title = "Distributions of the outcome variables (numbers of events)")
```
