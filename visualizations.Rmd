...
# Note: these direct links might change from time to time; refer to the database webpages
...
state_coord <- read_csv("https://raw.githubusercontent.com/ryancys1234/JSC370-Project/main/data/state_coord.csv")
...
## Distributions of the numerical variables by state {.tabset}
